        ...
        while (running) {
            ...
            if ("TERMINATE".equals(input.toUpperCase())) {
                ...
                while(!valid) {
                    ...
                    switch (answer) {
                        case 1-> sortBasedOnNameAscending();
                        case 2-> sortBasedOnTimeAscending();
                        case 3-> sortBasedOnCurrentLengthAscending();
                        case 4-> sortBasedOnIfNotFavourited();
                        case 5-> sortBasedOnName();
                        case 6-> sortBasedOnTime();
                        case 7-> sortBasedOnCurrentLength();
                        case 8-> sortBasedOnIfFavourited();
                        default -> valid = false;
                    }
                    if(valid == false){
